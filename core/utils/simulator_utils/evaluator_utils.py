...
class MetadriveEvaluator(InteractionSerialEvaluator):
    ...
    def eval(
        ...
        self._tb_logger.add_scalar('episode_info/succ_rate', success_ratio, train_iter)
        self._tb_logger.add_scalar('episode_info/succ_rate', success_ratio, envstep)
        self._tb_logger.add_scalar('episode_info/complete_ratio_mean', np.mean(complete_ratio_list), train_iter)
        self._tb_logger.add_scalar('episode_info/complete_ratio_mean', np.mean(complete_ratio_list), envstep)
        self._tb_logger.add_scalar('episode_info/complete_ratio_std', np.std(episode_reward), train_iter)
        self._tb_logger.add_scalar('episode_info/complete_ratio_std', np.std(episode_reward), envstep)
