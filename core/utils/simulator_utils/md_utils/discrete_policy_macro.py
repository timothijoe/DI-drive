...
class DiscreteMacroPolicy(BasePolicy):
    ...
    def __init__(self, control_object, random_seed):
        super(DiscreteMacroPolicy, self).__init__(control_object=control_object, random_seed=random_seed)
    ...
    def act(self, *args, **kwargs):
        ...
        # steering = steering + np.random.uniform(-0.8,0.8)
        # throtle_brake = throtle_brake + np.random.uniform(-0.8,0.8)
...
class HrlTrajPolicy(BasePolicy):

    def __init__(self, control_object, random_seed):
        super(HrlTrajPolicy, self).__init__(control_object=control_object, random_seed=random_seed)
