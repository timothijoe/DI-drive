...
from core.utils.simulator_utils.md_utils.discrete_policy_macro import HrlTrajPolicy
from core.utils.simulator_utils.md_utils.vehicle_utils import XadDefaultVehicle
...
class DiAgentManager(AgentManager):
...
class HrlAgentManager(AgentManager):

    def _get_policy(self, obj):
        policy = HrlTrajPolicy(obj, self.generate_seed())
        return policy
