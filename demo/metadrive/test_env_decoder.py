...
def main(cfg):
    ...
    policy._load_state_dict_collect(torch.load('/home/SENSETIME/zhoutong/hoffnung/xad/iros_result/feb21/cluster61/lateral_round/iteration_5000.pth.tar', map_location = 'cpu'))
