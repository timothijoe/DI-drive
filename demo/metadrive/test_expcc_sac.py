...
def main(cfg):
    ...
    policy._load_state_dict_collect(torch.load('/home/SENSETIME/zhoutong/hoffnung/xad/iros_result/feb26/cluster62/z5_expcc_sac_straight/iteration_50000.pth.tar', map_location = 'cpu'))
