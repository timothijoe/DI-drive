...
def main(cfg):
    ...
    import torch
    policy._load_state_dict_collect(torch.load('/home/SENSETIME/zhoutong/hoffnung/xad/iteration_ckpt/cluster62/exp2_sac_straight/ckpt_best.pth.tar', map_location = 'cpu'))
