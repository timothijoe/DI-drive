...
trex_reward_file = trex_reward_folder + '/reward_ckpt'
#trex_reward_file = '/home/SENSETIME/zhoutong/drive_project/ckpt/april15/a_reward_ckpt'
assert os.path.exists(trex_reward_file)
...
def main(cfg):
    ...
    reward_model = TrexRewardModelAD()
    reward_model.reward_model.load_state_dict(torch.load(trex_reward_file))
