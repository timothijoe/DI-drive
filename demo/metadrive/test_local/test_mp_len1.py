...
from core.envs.md_1step_env import MetaDriveOnestepEnv
...
def wrapped_env(env_cfg, wrapper_cfg=None):
    return DriveEnvWrapper(MetaDriveOnestepEnv(config=env_cfg), wrapper_cfg)
...
def main(cfg):
    ...
    import os
    pwd = os.getcwd() #/home/SENSETIME/zhoutong/hoffnung/xad/tiger_dongbei/mp_1/iteration_90000.pth.tar
    file_path = pwd + '/tiger_dongbei/mp_1/iteration_90000.pth.tar'
    import torch
