...
def main(cfg):
    ...
    import torch
    policy._load_state_dict_collect(torch.load('/home/SENSETIME/zhoutong/hoffnung/xad/iteration_ckpt/feb17/ppo/jerk_and_dense/iteration_10000.pth', map_location = 'cpu'))
